...
BASE_REPO_URL="https://github.com/biomage-ltd"
...
for repo in iac ui api developer-docs worker data-ingest pipeline inframock biomage-utils; do
 	git clone "${BASE_REPO_URL}/${repo}" "${biomage_home}/${repo}"
done
